...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__CreateForm__ = __webpack_require__(9);


new __WEBPACK_IMPORTED_MODULE_0__CreateForm__["a" /* default */]();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__convertSlug_js__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_numeral__ = __webpack_require__(31);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Quote__ = __webpack_require__(39);
...
var dataForm = function () {
    function dataForm() {
        ...
        document.querySelectorAll('.buttons-home').forEach(function (el) {
            el.addEventListener('click', function () {
                ...
                __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('/info-products', {
    ...
    _createClass(dataForm, [{
        key: 'buildElements',
        value: function buildElements(response) {
            this.data = response.data;
            document.querySelector('.formOne').classList.remove('is-hidden');
            loader.classList.remove('open');
            document.querySelector('#priceDisabled').value = __WEBPACK_IMPORTED_MODULE_2_numeral___default()(response.data['Valor'][0]).format('$0,0');

            var price = document.querySelector('#price');
            price.value = __WEBPACK_IMPORTED_MODULE_2_numeral___default()(response.data['Valor'][0]).format('$0,0');
            ...
            Object(__WEBPACK_IMPORTED_MODULE_3__Quote__["a" /* default */])();
        }
    }, {
        key: 'createElementsSelects',
        value: function createElementsSelects(elements, idSelect, priceValue) {
        ...
        key: 'createElementsInputs',
        value: function createElementsInputs(elements, contentElements, name) {
            var typeInput = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'radio';
            var checked = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : true;

            var contentEntry = document.getElementById(contentElements);
            var _self = this;
            elements.forEach(function (element, index) {
                ...
                input.setAttribute('id', Object(__WEBPACK_IMPORTED_MODULE_1__convertSlug_js__["a" /* default */])(element));
                input.setAttribute('name', name);
                input.setAttribute('type', typeInput);

                if (index === 0 && checked) input.setAttribute('checked', 'checked');
                if (typeInput === 'checkbox') input.setAttribute('data-price', _self.data['Valor Adiciones'][index]);

                label.setAttribute('for', Object(__WEBPACK_IMPORTED_MODULE_1__convertSlug_js__["a" /* default */])(element));
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_numeral__ = __webpack_require__(31);
...
/* harmony default export */ __webpack_exports__["a"] = (function () {
    ...
    var drinks = document.querySelectorAll('[name=waiter],[name=transport],[name=addition],.services,[name=quantity]');
...
function calculatePrice() {
    ...
    var price = parseInt(priceEl.dataset.baseprice),
        priceWhitAddition = priceByAddition(price);
    price = priceByQuantity(priceWhitAddition);
    price = priceByServices(price);

    priceEl.value = __WEBPACK_IMPORTED_MODULE_0_numeral___default()(price).format('$0,0');
    document.querySelector('#priceDisabled').value = __WEBPACK_IMPORTED_MODULE_0_numeral___default()(price).format('$0,0');
...
function priceByAddition(price) {
    ...
    var addition = document.querySelectorAll('[name=addition]');
